...
<div class="authentication">
    <div class="card">
        <div class="body">
            <h2>Selamat Datang di Halaman Pendaftaran Mahasiswa Baru</h2>
...
<?php
        //koneksi database
         $koneksi = mysqli_connect("localhost","root","", "uaslogin");
...
<h2 class="text-center"> PENDAFTARAN MAHASISWA  </h2>


<!--awal--->
<div class="card mt-5">
  <div class="card-header bg-primary text-white">
    Form Input Pendaftaran Mahasiswa
  </div>
  <div class="card-body">
